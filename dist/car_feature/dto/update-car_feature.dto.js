...
exports.UpdateCarFeatureDto = void 0;
const swagger_1 = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
const mapped_types_1 = require("@nestjs/mapped-types");
const create_car_feature_dto_1 = require("./create-car_feature.dto");
class UpdateCarFeatureDto extends (0, mapped_types_1.PartialType)(create_car_feature_dto_1.CreateCarFeatureDto) {
    car_id;
    feature_id;
}
