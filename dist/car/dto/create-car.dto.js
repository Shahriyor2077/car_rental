...
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'Rang kodi',
        example: 1
    }),
    (0, class_validator_1.IsNumber)({}, { message: 'Rang kodi raqam bo\'lishi kerak' }),
    (0, class_validator_1.IsPositive)({ message: 'Rang kodi musbat raqam bo\'lishi kerak' }),
    __metadata("design:type", Number)
