...
let AllExceptionsFilter = class AllExceptionsFilter {
    ...
    constructor(logger) {
        ...
        this.logger.error(`[${request.method}] ${request.url} - ${status} - ${JSON.stringify(message)}`, exception?.stack, 'ExceptionFilter');
...
exports.AllExceptionsFilter = AllExceptionsFilter = __decorate([
    (0, common_1.Catch)(),
    __param(0, (0, common_1.Inject)(winston_logger_service_1.WinstonLoggerService)),
